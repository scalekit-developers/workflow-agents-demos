...
All third-party API calls (Slack, GitHub) MUST go through
...
class ScalekitConnector:
    ...
    This checks if the user has authorized the given service (GitHub, Slack)
        through Scalekit's OAuth flow.

        Args:
            service: Service name ("github", "slack")
