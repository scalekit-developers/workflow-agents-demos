...
def setup_logging(name: str = __name__) -> logging.Logger:
    ...
    # Configure the root logger too, so module-level loggers in connectors.py,
    # aggregator.py, provisioning.py, and state.py (each just calls
    # logging.getLogger(__name__) with no handler of their own) propagate up
    # and actually get emitted, instead of silently hitting Python's WARNING+
    # lastResort handler because nothing above them was ever configured.
